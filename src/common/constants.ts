 ...
 * 组件类型，传值为对应索引
 */
export const ASSEMBLY_TYPE_MAP = ["脚本", "接口", "人工"];
 ...
 */
export const ASSEMBLY_SYSTEM_TYPE_MAP = ["Windows", "Unix/Linux"];

/**
 * 群组切换列表状态
 */
export const APP_GROUP_SWITCH_STATUS_DICT: Record<
  string,
...
> = {
  "0": {
    ...
    label: "未切换",
    colorHex: "#7ea6ea",
    field: "notSwitchCount",
  },
  "1": {
    color: "orange",
    label: "审批中",
    colorHex: "#f8d41f",
    field: "underApprovalCount",
  },
  "2": {
    color: "black",
    label: "已驳回",
  ...
  "3": {
    ...
    label: "切换中",
    colorHex: "#025afc",
    field: "switchingCount",
  },
  "4": {
    color: "green",
    label: "切换完成",
    colorHex: "#06eb72",
    field: "switchOverCount",
  },
  "5": {
    color: "red",
    label: "切换失败",
    colorHex: "#b40205",
    field: "switchFailCount",
  },
};
